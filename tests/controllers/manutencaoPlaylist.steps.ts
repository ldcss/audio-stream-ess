...
const feature = loadFeature(
  'tests/features/cadastro_manutencao_playlists.feature'
);
...
defineFeature(feature, (test) => { 
  ...
  test("Adicionar música a uma playlist como usuário logado", ({
    given,
    and,
    when,
    then,
  ...
  test("Excluir música da playlist como usuário logado", ({
    given,
    and,
    when,
    then,
