...
const feature = loadFeature(
  "tests/features/manutencao_artistas_artista.feature"
);
...
defineFeature(feature, (test) => {
  ...
  test("Atualizar artista como artista logado", ({
    given,
    and,
    when,
    then,
    ...
    when(
      ...
      (arg0, arg1, arg2, arg3) => {
        if (loggedInArtist.id !== arg1 || loggedInArtist.name !== arg0) {
          throw new Error(
            "Artista logado não é o mesmo que o artista a ser editado"
          );
        } else {
  ...
  test("Excluir artista como artista logado", ({ given, and, when, then }) => {
    ...
    when(
      ...
      (arg0, arg1, arg2, arg3) => {
        if (loggedInArtist.id !== arg1 || loggedInArtist.name !== arg0) {
          throw new Error(
            "Artista logado não é o mesmo que o artista a ser excluído"
          );
        } else {
          loggedInArtist.description = arg2;
          loggedInArtist.genre = arg3;
    ...
    then(
      ...
      (arg0, arg1, arg2, arg3) => {
        ...
        expect(ArtistRepository.prototype.deleteArtist).toHaveBeenCalledWith(
          arg1
        );
      }
    );
