...
class AlbumController {
  ...
  private initRoutes() {
    this.router.post(`${this.prefix}/:id/cadastro`, (req: Request, res: Response) =>
      this.createTest(req, res)
    );
    this.router.post(`${this.prefix}/manutencao/:id`, (req: Request, res: Response) =>
      this.createTest(req, res)
    );
    this.router.delete(`${this.prefix}/:id/remover/:id`, (req: Request, res: Response) =>
      this.createTest(req, res)
    );
  }
